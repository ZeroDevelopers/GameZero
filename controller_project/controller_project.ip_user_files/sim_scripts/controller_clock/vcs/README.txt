...
#
# Generated by export_simulation on Thu May 04 18:08:42 +0200 2017
#
################################################################################
...
switch to the './controller_clock.sh' script.

./controller_clock.sh -reset_run
...
./controller_clock.sh -noclean_files

For more information on the script, please type './controller_clock.sh -help'.
