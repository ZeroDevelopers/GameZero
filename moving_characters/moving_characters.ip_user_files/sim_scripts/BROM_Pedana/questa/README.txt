...
#
# Generated by export_simulation on Sun May 14 13:22:19 +0200 2017
#
################################################################################
...
switch to the './BROM_Pedana.sh' script.

./BROM_Pedana.sh -reset_run
...
./BROM_Pedana.sh -noclean_files

For more information on the script, please type './BROM_Pedana.sh -help'.
