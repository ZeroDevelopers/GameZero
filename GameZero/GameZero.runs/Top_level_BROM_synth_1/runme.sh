...
HD_PWD='C:/Users/Andrea Diecidue/Documents/GameZero/GameZero/GameZero.runs/Top_level_BROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_level_BROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_level_BROM.tcl
