...
HD_PWD='C:/Users/Andrea Diecidue/Documents/GameZero/GameZero/GameZero.runs/Wolvie_BROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Wolvie_BROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Wolvie_BROM.tcl
