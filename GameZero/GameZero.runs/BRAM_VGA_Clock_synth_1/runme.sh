...
HD_PWD='C:/Users/Andrea Diecidue/Documents/GitHub/GameZero/GameZero/GameZero.runs/BRAM_VGA_Clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_VGA_Clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_VGA_Clock.tcl
