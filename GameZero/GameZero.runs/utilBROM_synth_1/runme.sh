...
HD_PWD='C:/Users/Andrea Diecidue/Documents/GitHub/GameZero/GameZero/GameZero.runs/utilBROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log utilBROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source utilBROM.tcl
