...
HD_PWD='C:/Users/Andrea Diecidue/Desktop/polito/Computer Architecture/Projects/vga/vga.runs/PixelClkGen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PixelClkGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PixelClkGen.tcl
