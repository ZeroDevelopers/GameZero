...
#
# Generated by export_simulation on Fri Jun 02 14:33:04 +0200 2017
#
################################################################################
...
switch to the './pixelClkGen.sh' script.

./pixelClkGen.sh -reset_run
...
./pixelClkGen.sh -noclean_files

For more information on the script, please type './pixelClkGen.sh -help'.
