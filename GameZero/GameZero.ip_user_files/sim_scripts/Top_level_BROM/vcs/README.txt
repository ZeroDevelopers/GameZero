...
#
# Generated by export_simulation on Mon Jun 12 10:43:07 +0200 2017
#
################################################################################
...
switch to the './Top_level_BROM.sh' script.

./Top_level_BROM.sh -reset_run
...
./Top_level_BROM.sh -noclean_files

For more information on the script, please type './Top_level_BROM.sh -help'.
