...
#
# Generated by export_simulation on Mon Jun 12 10:28:56 +0200 2017
#
################################################################################
...
switch to the './playerBROM.sh' script.

./playerBROM.sh -reset_run
...
./playerBROM.sh -noclean_files

For more information on the script, please type './playerBROM.sh -help'.
