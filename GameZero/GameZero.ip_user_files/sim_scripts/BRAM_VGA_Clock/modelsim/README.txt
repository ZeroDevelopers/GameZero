...
#
# Generated by export_simulation on Tue Apr 25 16:51:36 +0200 2017
#
################################################################################
...
switch to the './BRAM_VGA_Clock.sh' script.

./BRAM_VGA_Clock.sh -reset_run
...
./BRAM_VGA_Clock.sh -noclean_files

For more information on the script, please type './BRAM_VGA_Clock.sh -help'.
