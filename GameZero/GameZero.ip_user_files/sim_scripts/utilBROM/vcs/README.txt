...
#
# Generated by export_simulation on Mon Jun 12 10:42:22 +0200 2017
#
################################################################################
...
switch to the './utilBROM.sh' script.

./utilBROM.sh -reset_run
...
./utilBROM.sh -noclean_files

For more information on the script, please type './utilBROM.sh -help'.
